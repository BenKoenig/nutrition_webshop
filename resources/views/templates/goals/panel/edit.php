<div class="adminForm">
    ...
    <form class="adminForm__form" action="<?php echo BASE_URL . "/admin/goals/" . $goal->id . "/edit/update" ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="adminForm__form__imgs">
            ...
            foreach ($goal->getImages() as $image) : ?>
                <div class="adminForm__form__imgs__item">
                    <img src="<?php echo BASE_URL . $image; ?>" alt="<?php echo $goal->name; ?>" class="adminForm__form__imgs__item__tn">
        ...
        <div class="adminForm__form__btns">
            ...
            <a class="btn btn--red" href="<?php echo BASE_URL . '/admin/goals'; ?>">Cancel</a>
        </div>
