<nav class="nav">
    <div class="nav__mobile">
        ...
        <a class="nav__mobile__a nav__mobile__a--open_menu" href="#"><span class="sr-only">Menu</span><svg class="nav__mobile__a--svg" viewBox="0 0 32 32" xml:space="preserve">
        ...
        <div class="nav__mobile__overlay sr-only">
            <ul class="nav__mobile__overlay__ul">
                <li class="nav__mobile__overlay__ul__li"><a class="nav__mobile__overlay__ul__li__a" href="<?php echo BASE_URL; ?>/categories">Categories</a></li>
                <li class="nav__mobile__overlay__ul__li"><a class="nav__mobile__overlay__ul__li__a" href="<?php echo BASE_URL; ?>/sales">Sales</a></li>
                <li class="nav__mobile__overlay__ul__li"><a class="nav__mobile__overlay__ul__li__a" href="<?php echo BASE_URL; ?>/new">New</a></li>
                <?php if (\Core\Middlewares\AuthMiddleware::isAdmin()) : ?>
                    <li class="nav__mobile__overlay__ul__li"><a class="nav__mobile__overlay__ul__li__a" href="<?php echo BASE_URL; ?>/admin">Admin</a></li>
                <?php endif; ?>
            </ul>
        </div>
    </div>
    ...
    <div class="nav__desktop">
        <div class="nav__desktop__container">
            ...
            <a href="<?php echo BASE_URL . '/cart'; ?>" class="nav__desktop__container__cart">Cart (<?php echo \App\Services\CartService::getCount(); ?>)<svg class="nav__desktop__container__cart--svg" class="xmlns=" http://www.w3.org/2000/svg" xml:space="preserve" viewBox="0 0 510 510">
