...
namespace App\Controllers\Flavors;
...
class FlavorPanelController
{
    public function index()
    {
        AuthMiddleware::isAdminOrFail();
        $flavors = Flavor::all('id', 'ASC');
        View::render('flavors/panel/index', [
            'flavors' => $flavors
        ]);
    }
    ...
    public function edit(int $id)
    {
         ...
         */
        View::render('flavors/panel/edit', [
            'flavor' => $flavor
        ]);
    }
    ...
    public function update(int $id)
    {
        ...
        if (!empty($validationErrors)) {
             ...
             */
            Redirector::redirect("/admin/flavors/${id}/edit");
        }
         ...
         */
        Redirector::redirect('/admin/flavors');
    }
    ...
    public function create()
    {
        ...
        View::render('flavors/panel/create');
    }
    ...
    public function store()
    {
        ...
        if (!$flavor->save()) {
            ...
            Session::set('errors', ['Speichern fehlgeschlagen.']);
            Redirector::redirect("/admin/flavors/create");
        }
    ...
    public function delete(int $id)
    {
        ...
        View::render('helpers/confirmation', [
            'objectType' => 'Flavor',
            'objectTitle' => $flavor->flavor,
            'confirmUrl' => BASE_URL . '/admin/flavors/' . $flavor->id . '/delete/confirm',
            'abortUrl' => BASE_URL . '/admin/flavors'
        ]);
    }
